...
def get_notes(cookie):
    # 清理 cookie 字符串，移除多余的引号和转义字符
    cookie = cookie.strip('"').replace('\x3b', ';')
...
if __name__ == "__main__":
    ...
    parser.add_argument("minote_cookie", help="Your Mi Note cookie")
    parser.add_argument("save_dir", help="Directory to save notes")
