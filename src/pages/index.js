  ...
  return (
    <>
      ...
      <div className="relative min-h-screen">
        ...
        <div
          className={`pt-8 pb-20 px-4 sm:px-8 ${!displayMode.isMobile && !displayMode.isLargeScreen
                ...
                <div className="w-full mb-6">
                  <div className="max-w-2xl mx-auto">
                    <Card hoverEffect={false}>
                      <a
                        href="https://nicoletteblog.vercel.app/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block w-full py-2 text-center text-lg tracking-wider font-mono"
                      >
                        新网站入口
                      </a>
                    </Card>
